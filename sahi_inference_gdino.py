...
from sahi.models.groundedsam2 import GroundedSam2DetectionModel
from sahi.predict import get_prediction, get_sliced_prediction, predict
...
def main(args):
    ...
    # Create the model
    detection_model = GroundedSam2DetectionModel(
...
if __name__ == "__main__":
    """
    model = GroundedSam2DetectionModel(
        model_path=args.gd_checkpoint,
        config_path=args.gd_config,
        sam2_checkpoint=args.sam2_checkpoint,
        sam2_config=args.sam2_config,
    ...
    parser.add_argument("--gd_checkpoint", type=str, help="Path to the Grounding DINO model file.")
    parser.add_argument("--sam2_checkpoint", type=str, help="Path to the SAM2 model file.")
    parser.add_argument("--gd_config", type=str, help="Path to the Grounding DINO config file.")
    parser.add_argument("--sam2_config", type=str, help="Path to the SAM2 config file.")
    parser.add_argument("--text_prompt", type=str, help="Text prompt for Grounding DINO")
