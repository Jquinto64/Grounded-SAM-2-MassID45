...
<<<<<<< HEAD:grounded_sam2_tracking_demo_custom_video_input_dinox.py
task = V2Task(
...
>>>>>>> local_dev_gsa/massid45:demo_scripts/grounded_sam2_tracking_demo_custom_video_input_dinox.py
)
